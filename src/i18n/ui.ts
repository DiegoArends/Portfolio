...
export const ui = {
  es: {
    ...
    'hero.desc': 'especializado en el ecosistema <span class="text-emerald-500">React & Node.js</span>. Enfocado en construir aplicaciones escalables que transforman datos complejos en experiencias de usuario fluidas.',
    ...
    'about.p1': 'Mi trayectoria une el <span class="text-white">desarrollo de software</span> con una sólida base en <span class="text-emerald-500">Administración de Empresas</span>, lo que me permite aportar una visión estratégica y analítica a cada producto digital.',
  ...
  en: {
    ...
    'hero.desc': 'specialized in the <span class="text-emerald-500">React & Node.js</span> ecosystem. Focused on building scalable applications that transform complex data into fluid user experiences.',
    ...
    'about.p1': 'My career combines <span class="text-white">software development</span> with a solid background in <span class="text-emerald-500">Business Administration</span>, allowing me to bring a strategic and analytical vision to every digital product.',
